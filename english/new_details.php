				...
				<div class="col-lg-12">
					<div class="breatcome_title">
						<div class="breatcome_title_inner pb-2">
							...
							$stmt = $DB->prepare("SELECT  noticiaEn FROM `noticias` WHERE idNoticia=?");
    ...
    <div class="blog_area blog-details-area pt-100 pb-100" id="blog">
		...
		<div class="container">		
			<div class="row">	
                ...
                <?php                    
							$stmt = $DB->prepare("SELECT  noticiaEn,descNoticiaEn,data,imagem FROM `noticias` WHERE idNoticia=?");
        					$stmt->bind_param("s", $_GET['idNoticia']);
							$stmt->execute(); 
              ...
              ";  
						...
						<div class="col-md-12">
							<div class="recent_post_dtls mt-5">
								...
								<div class="row">
                  <?php
						$stmt = $DB->prepare("SELECT idNoticia,noticiaEn,descNoticiaEn,data,imagem FROM noticias WHERE 1 ORDER BY data DESC LIMIT 2");
						$stmt->execute(); 
